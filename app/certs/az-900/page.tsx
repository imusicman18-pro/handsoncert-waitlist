...
export const metadata: Metadata = {
  title: "AZ-900 Hands-On Labs | HandsOnCert",
  description: "AZ-900 Azure Fundamentals hands-on labs. 3 real Azure projects, auto-committed to your GitHub portfolio. $29 one-time, Project 1 free.",
  alternates: {
    canonical: "https://www.handsoncert.com/certs/az-900/",
  },
  openGraph: {
    title: "AZ-900 Hands-On Labs | HandsOnCert",
    description: "AZ-900 Azure Fundamentals hands-on labs. 3 real Azure projects, auto-committed to your GitHub portfolio. $29 one-time, Project 1 free.",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "AZ-900",
      "item": "https://www.handsoncert.com/certs/az-900/"
    }
  ]
}
...
const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  "name": "How to complete the AZ-900 hands-on lab path on HandsOnCert",
  "description": "3 hands-on projects mapped to AZ-900 exam objectives, with evidence auto-committed to your GitHub portfolio.",
  "totalTime": "PT4H",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Cloud Concepts",
      "text": "Explore core cloud concepts — shared responsibility model, CapEx vs OpEx, and the benefits of cloud computing. Use the Azure Pricing Calculator and TCO Calculator to compare cloud vs on-prem costs. Commit your pricing comparison screenshots to GitHub."
    },
    {
      "@type": "HowToStep",
      "name": "Azure Architecture and Services",
      "text": "Explore Azure's core architectural components — regions, availability zones, resource groups. Deploy a storage account and a basic VM, and explore compute, networking, and storage service categories. Commit your resource configuration screenshots."
    },
    {
      "@type": "HowToStep",
      "name": "Management and Governance",
      "text": "Explore Azure Cost Management, Azure Advisor, and Azure Policy. Set up a budget alert and apply a basic policy. Commit your cost management dashboard and policy configuration screenshots."
    }
  ]
}
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Are the AZ-900 hands-on labs free?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you need an Azure free trial or pay-as-you-go subscription. AZ-900 labs are designed to fit within Azure's free tier — total cost should be near $0 if resources are cleaned up promptly after each project."
      }
    },
    {
      "@type": "Question",
      "name": "How does the GitHub portfolio auto-commit work for AZ-900?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How long does the AZ-900 path take to complete?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The 3 projects take approximately 4 hours total, covering Cloud Concepts, Azure Architecture and Services, and Management and Governance — the same domains tested on the AZ-900 exam."
      }
    },
    {
      "@type": "Question",
      "name": "Is AZ-900 a good certification for someone with no IT background?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. AZ-900 has no prerequisites and is designed for anyone — including non-technical roles like sales, marketing, or project management — who wants to understand cloud computing fundamentals and Azure specifically."
      }
    },
    {
      "@type": "Question",
      "name": "Should I take AZ-900 before AZ-104?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AZ-900 is recommended if you're new to Azure or cloud computing, since it builds foundational vocabulary and concepts. If you already have hands-on cloud experience, you can go directly to AZ-104 (Azure Administrator Associate), HandsOnCert's most popular path."
      }
    }
  ]
}
...
const courseSchema = {
  "@context": "https://schema.org",
  "@type": "Course",
  "name": "AZ-900 Hands-On Lab Path",
  "description": "3 hands-on projects mapped to AZ-900 exam objectives, with GitHub portfolio auto-commit.",
  "provider": {
    "@type": "Organization",
    "name": "HandsOnCert",
...
const techArticleSchema = {
  ...
  "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.handsoncert.com/certs/az-900/" },
}
...
<div className="container">
  <div className="hero">
    ...
    <h1>AZ-900 Hands-On Labs<br /><em>Real Azure. Real GitHub portfolio.</em></h1>
    <p className="hero-desc">Three real Azure Fundamentals projects mapped directly to the AZ-900 exam objectives. Mark a step complete and HandsOnCert commits the evidence — screenshots, configs, pricing calculations — straight to your own GitHub repo. The portfolio employers actually click into.</p>
  ...
  <div className="stats">
    ...
    <div className="stat"><div className="stat-num">$99</div><div className="stat-label">AZ-900 exam cost</div></div>
...
<section id="projects">
  <div className="container">
    ...
    <p className="sec-sub">Every project maps to an official AZ-900 exam domain. Each one ends with evidence committed to your GitHub repo automatically.</p>
    <div className="steps">
      <div className="step">
        <div className="step-num">1</div>
        <div className="step-text">
          <h3>Cloud Concepts — Free</h3>
          <p>Explore core cloud concepts — shared responsibility model, CapEx vs OpEx, and the benefits of cloud computing. Use the Azure Pricing Calculator and TCO Calculator to compare cloud vs on-prem costs. Commit your pricing comparison screenshots to GitHub.</p>
          <span className="step-domain">Cloud Concepts — 25-30% of exam</span>
        </div>
      </div>
      <div className="step">
        <div className="step-num">2</div>
        <div className="step-text">
          <h3>Azure Architecture and Services</h3>
          <p>Explore Azure's core architectural components — regions, availability zones, resource groups. Deploy a storage account and a basic VM, and explore compute, networking, and storage service categories. Commit your resource configuration screenshots.</p>
          <span className="step-domain">Azure Architecture &amp; Services — 35-40% of exam</span>
        </div>
      </div>
      <div className="step">
        ...
        <div className="step-text">
          ...
          <p>Explore Azure Cost Management, Azure Advisor, and Azure Policy. Set up a budget alert and apply a basic policy. Commit your cost management dashboard and policy configuration screenshots.</p>
          <span className="step-domain">Azure Management &amp; Governance — 30-35% of exam</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="container">
    ...
    <div className="benefits-grid">
      ...
      <div className="benefit">
        ...
        <p>No simulators. You work in the actual Azure console and tools, the same ones you'll use on the job and in the AZ-900 exam.</p>
      </div>
      <div className="benefit">
        <div className="benefit-icon">🤖</div>
        <h3>Cert Buddy AI mentor</h3>
        <p>Stuck on a step or an exam concept? Cert Buddy is trained on AZ-900 objectives and helps you debug and understand — not just copy-paste.</p>
      </div>
      <div className="benefit">
        <div className="benefit-icon">💰</div>
      ...
      <div className="benefit">
        ...
        <p>Get the full AZ-900 lab guide as a PDF — step-by-step instructions, screenshots to capture, and an exam quick-reference section.</p>
      </div>
      <div className="benefit">
        <div className="benefit-icon">💵</div>
  ...
  <div className="container">
    ...
    <div className="faq-list">
      <div className="faq-item">
        <p className="faq-q">Are the AZ-900 hands-on labs free?</p>
      ...
      <div className="faq-item">
        ...
        <p className="faq-a">Yes, you need an Azure free trial or pay-as-you-go subscription. AZ-900 labs are designed to fit within Azure's free tier — total cost should be near $0 if resources are cleaned up promptly after each project.</p>
      </div>
      <div className="faq-item">
        <p className="faq-q">How does the GitHub portfolio auto-commit work for AZ-900?</p>
      ...
      <div className="faq-item">
        <p className="faq-q">How long does the AZ-900 path take to complete?</p>
        <p className="faq-a">The 3 projects take approximately 4 hours total, covering Cloud Concepts, Azure Architecture and Services, and Management and Governance — the same domains tested on the AZ-900 exam.</p>
      </div>
      <div className="faq-item">
        <p className="faq-q">Is AZ-900 a good certification for someone with no IT background?</p>
        <p className="faq-a">Yes. AZ-900 has no prerequisites and is designed for anyone — including non-technical roles like sales, marketing, or project management — who wants to understand cloud computing fundamentals and Azure specifically.</p>
      </div>
      <div className="faq-item">
        <p className="faq-q">Should I take AZ-900 before AZ-104?</p>
        <p className="faq-a">AZ-900 is recommended if you're new to Azure or cloud computing, since it builds foundational vocabulary and concepts. If you already have hands-on cloud experience, you can go directly to AZ-104 (Azure Administrator Associate), HandsOnCert's most popular path.</p>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div className="container">
    <div className="cta-section">
      <h2>Build your AZ-900 portfolio today</h2>
