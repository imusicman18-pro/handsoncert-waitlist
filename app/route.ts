...
<meta name="description" content="Hands-on cloud certification labs with real projects, GitHub portfolio commits, and an AI mentor. 23 cert paths live now. Pay once per cert — no subscription.">
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-right">
      <div class="nav-pill">23 cert paths live</div>
...
<section class="hero">
  <div class="hero-inner">
    <div class="live-badge">
      ...
      Platform live — 23 cert paths available now
    </div>
...
<section class="section alt" id="certs">
  <div class="sec-inner">
    ...
    <div style="text-align:center; margin-top: 1.25rem;">
      <a href="/certs/" class="btn-ghost" style="font-size:14px;">View all 23 certs →</a>
    </div>
  </div>
</section>
  ...
  <div class="sec-inner">
    ...
    <div class="steps-grid">
      <div class="step-block">
        ...
        <p>Choose from 23 live paths across Azure, AWS, GCP, HashiCorp, and CNCF. Project 1 of any cert is completely free.</p>
      </div>
      <div class="step-block">
...
<section class="section">
  <div class="sec-inner">
    ...
    <div class="sec-title">Multi-cloud. Multi-track. 23 cert paths live.</div>
    <p class="sec-sub">Every cert path built from official exam objectives. All 23 paths live now — SC-500 and AI-901 coming when Microsoft publishes objectives.</p>
